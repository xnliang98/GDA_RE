...
def get_parser():
    ...
    parser.add_argument('--second_layer', type=int, default=2, help='Num of GCN layers.')
    ...
    parser.add_argument('--pe_emb', type=int, default=30, help='Position encoding dimension.')
